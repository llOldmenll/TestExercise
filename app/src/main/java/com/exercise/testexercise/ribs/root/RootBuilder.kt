...
import com.exercise.testexercise.di.NetworkModule
...
class RootBuilder(dependency: ParentComponent) :
     ...
     */
    fun build(parentViewGroup: ViewGroup, appContext: Context): RootRouter {
    ...
    interface Component : InteractorBaseComponent<RootInteractor>, BuilderComponent,
        SplashBuilder.ParentComponent, AvailableFlightsBuilder.ParentComponent {
